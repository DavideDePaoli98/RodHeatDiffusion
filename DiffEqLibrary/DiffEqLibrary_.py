...
def bar_builder (temperature_left_,temperature_right_,temperature_bar_,dim_X_=100,dim_t_=100):
    ...
    Parameters: left thermostat temperature,right thermostat temperature,bar initial temperature.
    
    Returns: the initial state of the bar temperature and the values of the two thermostats kept costant in time.'''
...
def bar_builder_well (temperature_left_ ,temperature_right_, temperature_bar_,well_position_,temperature_well_,lenght_,dim_X_=100,dim_t_=100):
    ...
    Parameters: left thermostat temperature,right thermostat temperature,bar i nitial temperature,the third thermostat position,
    the third thermostat temperature, the lenght of the bar
    
    Returns: the initial state of the bar temperature and the values of the three thermostats kept costant in time. '''
...
def DFF(lenght_,time_,bar_,linear_diffusion_=0.00002):
    ...
    Parameters: the bar lenght,the simulation interval of time, the initial state of the bar (return of the bar_builder or bar_builder_well functions).
    
    Returns: the evolution of the bar temperature profile during the simulation.'''
...
def DFF_well(lenght_,time_,bar_,well_position_,linear_diffusion_=0.00002):
    ...
    Parameters: the bar lenght,the simulation interval of time, the initial state of the bar (return of the bar_builder or bar_builder_well functions)
    and the position of the third thermostat.
...
def graph_time_t(lenght_,time_,istant_,bar_):
    ...
    Parameters: lenght of the bar, time of the simulation, istant of the simulation to be represented, 
    the evolution of the bar temperature profile during the simulation (return of the functions that applied a finite difference methods)
...
def plot_3D (lenght_,time_,bar_):
    ...
    Parameters: lenght of the bar, time of the simulation,the evolution of the bar temperature profile during the simulation 
    (return of the functions that applied a finite difference methods)
...
def methods_comparison_well(lenght_,time_,bar_,well_position_):
    ...
    Parameters: lenght of the bar, time of the simulation,the evolution of the bar temperature profile during the simulation 
    (return of the functions that applied a finite difference methods) and the position of the third thermostat.
