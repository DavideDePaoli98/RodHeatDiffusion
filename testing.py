...
def test_DFF(temperature_left,temperature_right,temperature_bar,lenght,time):
    ...
    during the entire simulation time. It also controls if the return is different from the initial bar configuration.'''
...
def test_DFF_well(temperature_left,temperature_right,temperature_bar,lenght,time,well_position,temperature_well):
    ...
    '''Test to control if the return of the finite difference method functions have fixed temperatures in the extremetes
    and in the well during the entire simulation time. It also controls if the return is different from the initial bar configuration.'''
